...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    // On small screens the pinned-stacking effect is janky on touch and its
    // transforms can bleed over the following section. Render the cards as a
    // plain vertical list instead — no lenis, no transforms.
    const isMobile =
